...
7. **In-app notification centre** on top of the watchlist feed. Unread state shipped (`profiles.feedSeenAt`, dashboard "From your watchlist" section, sidebar count — `docs/FOLLOWS.md`); still open: a bell with the notification list, per-target mutes.
