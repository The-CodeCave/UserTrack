...
export function CopyForAgent({ prompt, surface, label = "Copy to LLM", hint, className, onCopy }: { prompt: string; surface: string; label?: string; hint?: string; className?: string; onCopy?: () => void }) {
  ...
  return (
    <div className={cn("flex flex-wrap items-center gap-x-3 gap-y-1", className)}>
      ...
      >
        ...
        {copied ? "Copied — paste into your LLM" : label}
      </button>
