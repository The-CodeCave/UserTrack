...
export const metadata: Metadata = {
  ...
  description: "SaaS products gaining meaningful traction right now — ranked by the UserTrack Trending Score (new users × growth × acceleration × trust), not by size.",
      ...
      <Panel id="how" className="mt-10 p-5">
        ...
        <div className="mt-3 grid gap-4 text-sm md:grid-cols-2">
          <div className="font-mono text-[13px] leading-relaxed">
            score = 100 · <span className="text-pink">volume</span> · growth · acceleration · trust · activation<br />
