// ISO 3166-1 alpha-2 codes with English names (sorted by name); the flag is derived from the code.
...
export const countryFlag = (code: string) => String.fromCodePoint(...[...code.toUpperCase()].map((ch) => 0x1f1e6 + ch.charCodeAt(0) - 65));
