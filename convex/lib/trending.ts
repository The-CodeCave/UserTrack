 ...
 *
 * score = 100 · volume · growth · acceleration · trust · activation · freshness · history
 *
...
export function trendingScore(i: TrendingInput) {
  ...
  return Math.round(100 * f.volume * f.growth * f.acceleration * f.trust * f.activation * f.freshness * f.history * 10) / 10;
}

// Short human explanation for cards ("2.1× prev period · +12% relative · 61% activate").
